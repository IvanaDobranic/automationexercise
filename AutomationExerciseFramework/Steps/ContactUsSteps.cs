...
namespace AutomationExerciseFramework.Steps
{
    ...
    public class ContactUsSteps : Base
    {
        ...
        [When(@"confirms the propt message")]
        public void WhenConfirmsTheProptMessage()
        {
        ...
        {
            Assert.True(ut.TextPresentInElement(successMessage), "User's message was not sent successfully via contact");
        }
    }
}
